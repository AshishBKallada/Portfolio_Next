    ...
    <div className=" overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row flex-shrink-2 justify-center items-center gap-2">
        <Container className="h-24 w-24 circle-1">
          <MongoDB className="h-12 w-12 " />
        </Container>
        <Container className="h-24 w-24 circle-2">
        <Express className="h-12 w-12 " />
        </Container>
        <Container className="h-36 w-36 circle-5">
          <React className="h-20 w-20 " />
        </Container>
        <Container className="h-24 w-24 circle-3">
          <Node className="h-12 w-2120 dark:text-white" />
        </Container>
        <Container className="h-24 w-24 circle-4">
        <AWS className="h-12 w-12 dark:text-white" />
        </Container>
