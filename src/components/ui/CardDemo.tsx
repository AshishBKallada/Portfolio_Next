...
const Skeleton = () => {
  const scale = [1, 1.1, 1];
  const transform = ["translateY(0px)", "translateY(-20px)", "translateY(0px)"];
  const sequence = [
    [
      ".circle-1",
      {
  ...
  return (
    <div className=" overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row flex-shrink-2 justify-center items-center gap-2">
        <Container className="h-24 w-24 circle-1">
          <ClaudeLogo className="h-12 w-12 " />
        </Container>
        <Container className="h-24 w-24 circle-2">
          <GoCopilot className="h-12 w-12 dark:text-white" />
        </Container>
        <Container className="h-36 w-36 circle-3">
          <OpenAILogo className="h-20 w-20 dark:text-white" />
        </Container>
        <Container className="h-24 w-24 circle-4">
          <MetaIconOutline className="h-12 w-12 " />
        </Container>
        <Container className="h-24 w-24 circle-5">
          <GeminiLogo className="h-12 w-12 " />
        </Container>
      </div>

      <div className="h-40 w-px absolute top-20 m-auto z-40 bg-gradient-to-b from-transparent via-cyan-500 to-transparent animate-move">
        <div className="w-10 h-72 top-1/2 -translate-y-1/2 absolute -left-10">
          <Sparkles />
        </div>
      </div>
    </div>
